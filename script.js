...
//устонавливаем размер холста по размерам видимой части элемента canvas
...
document.getElementById("save_image").onclick = function(){
    ...
    //переносим на холсте сохранения холст заднего фона
...
//ждём событие изменения цвета для палитры заднего фона
...
//ждём событие изменения инструмента
...
//ждём событие клика по кнопке очистке
